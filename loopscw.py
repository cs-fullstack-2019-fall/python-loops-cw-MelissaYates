...
print("The average of " + " "+ str(NUMBER1) + " "+ str(NUMBER2) + " "+ str(NUMBER3) + " is " + " "+ str(AVERAGE))
# Ex.Output
# ```
...
for x in range(0, 101):
    if (x % 4 == 0):
        print(x)
# ### Challenge:
# Password Checker - Ask the user to enter a password. Ask them to confirm the password. If it's not equal,
# keep asking until it's correct or they enter 'Q' to quit.
